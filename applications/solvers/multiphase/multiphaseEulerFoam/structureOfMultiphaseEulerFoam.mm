...
<node TEXT="ArdenBuck equation for the vapour pressure of moist air." ID="ID_1643583932" CREATED="1611567021984" MODIFIED="1611567028123"/>
</node>
...
<node TEXT="Saturation vapour temperature in terms of the vapour pressure (in Pa). The saturation temperature in Kelvins is specified as a Foam::Function1 type, to enable use of, e.g. constant, polynomial, table values." ID="ID_1974945968" CREATED="1611568282554" MODIFIED="1611568303841"/>
</node>
...
<node TEXT="Ranz-Marshall correlation for turbulent heat transfer from the surface of a sphere to the surrounding fluid." ID="ID_1380063610" CREATED="1611566470030" MODIFIED="1611566478142"/>
</node>
<node TEXT="sphericalHeatTransfer" ID="ID_1140499536" CREATED="1611351751688" MODIFIED="1611351761119">
<node TEXT="Model which applies an analytical solution for heat transfer from the surface of a sphere to the fluid within the sphere." ID="ID_18859001" CREATED="1611566491163" MODIFIED="1611566500827"/>
</node>
